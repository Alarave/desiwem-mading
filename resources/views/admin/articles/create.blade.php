...
@section('title', 'Buat Artikel Baru — DeSiWeM')
...
<div class="mb-4">
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h4 class="fw-bold mb-0" style="font-family: var(--font-display); letter-spacing: -0.02em; color: var(--base-900);">Tulis Artikel Baru</h4>
                <small class="text-muted">Susun pengumuman, opini, puisi, karya sastra, atau artikel ilmiah mading.</small>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="carbon-editor-main">
            ...
            <div>
                <input type="text" 
                       ...
                       placeholder="Tuliskan judul artikel yang berbobot di sini..."
                       value="{{ old('title') }}" 
                       required 
                       autofocus>
            </div>
            ...
            <div class="carbon-editor-card">
                ...
                <div id="writePane">
                    <textarea name="content" 
                              ...
                              placeholder="Mulai ketikkan narasi artikel Anda di sini... Anda dapat menggunakan format Markdown seperti # Judul, **tebal**, atau kutipan >."
                              required>{{ old('content') }}</textarea>
                </div>

                <!-- Live Preview View -->
                <div id="previewPane" class="d-none">
                    <div class="carbon-editor-preview-container carbon-prose" id="previewContainer">
                        <p class="text-muted fst-italic">Belum ada konten yang ditulis...</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="carbon-editor-meta-panel">
            ...
            <div class="carbon-meta-box">
                <div class="carbon-meta-title">
                    <i class="bi bi-send-fill text-accent"></i> Publikasi
                </div>
                <p class="small text-muted mb-3">Artikel yang dipublikasikan akan langsung tampil di galeri mading utama.</p>
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('admin.articles') }}" class="btn btn-sm btn-outline-secondary py-2 text-muted" style="border-color: var(--base-200);">
                        Batal
                    </a>
                </div>
            </div>
            ...
            <div class="carbon-meta-box">
                ...
                <small class="text-muted d-block mt-2">Artikel akan dikelompokkan sesuai rubrik di atas.</small>
            </div>
            ...
            <div class="carbon-meta-box">
                ...
                <div id="imgPreviewWrapper">
                    <div id="imgPlaceholder" class="carbon-img-placeholder">
                        <i class="bi bi-card-image fs-3"></i>
                        <span>Pratinjau gambar sampul</span>
                    </div>
                    <img id="imgPreview" src="" alt="Pratinjau Sampul" class="carbon-img-preview d-none">
                </div>
            </div>
        </div>
    </div>
